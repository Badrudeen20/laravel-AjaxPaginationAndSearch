    ...
    <table class="table table-striped table-bordered">
     <thead>
      <tr>
       ...
       <th width="38%" class="sorting" data-sorting_type="asc" data-column_name="post_title" style="cursor: pointer">Food<span id="post_title_icon"></span></th>
       <th width="57%">Price</th>
      </tr>
     </thead>
     <tbody>
          @include('webslesson.pagination_data') 
     </tbody>
    </table>
